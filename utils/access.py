...
# Иерархия доступа: строго нижестоящие по роли, в пределах своей организации
# (Лидер/Следящий) или направления (Старший следящий). Руководство и Создатель
# ограничений по организации/направлению не имеют.
...
def can_manage(admin: "UserInfo", target: "UserInfo") -> bool:
    """True, только если target строго ниже admin по роли и в его зоне
    ответственности."""
...
def max_grantable_role(admin: "UserInfo") -> Role:
    """Максимальная роль, которую admin вправе выдать (строго ниже своей)."""
    if admin.role >= Role.LEADERSHIP:
